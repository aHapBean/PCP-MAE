...
DATA_PATH = "E/data/s3dis/Stanford3dDataset_v1.2_Aligned_Version/"        # DPTA path !
# g_classes = [x.rstrip() for x in open(os.path.join(BASE_DIR, 'meta/class_names.txt'))]
g_classes = [x.rstrip() for x in open("../../semantic_segmentation/data_utils/meta/class_names.txt")]   # tuned conbined with reality
